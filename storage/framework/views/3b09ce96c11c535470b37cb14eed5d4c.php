...
<head>
    ...
    <style>
        :root {
            --primary-color: <?php echo e(settings('primary_color', '#1db6c5')); ?>;
            --secondary-color: <?php echo e(settings('secondary_color', '#001848')); ?>;
            --accent-color: <?php echo e(settings('accent_color', '#1db6c5')); ?>;
        }
                                ...
                                <div class="site-navigation d-flex flex-row">
                                    <div class="site-branding">
                                        <a class="home-link" href="/" title="<?php echo e(settings('site_name', 'CSA Education')); ?>" rel="home">
                                            <img id="logo-img" class="img-fluid auto_size" alt="<?php echo e(settings('site_name', 'CSA Education')); ?>" width="200" height="60" src="<?php echo e(settings('logo') ? asset('storage/' . settings('logo')) : asset('images/csa-logo.svg')); ?>">
                                        </a>
                                    </div>
                            ...
                            <div class="widget widget_nav_menu clearfix">
                               <h3 class="widget-title">Contact Us</h3>
                                <ul class="widget_contact_wrapper">
                                    ...
                                    <li><h3>location:</h3> <?php echo e(settings('address')); ?><?php echo e(settings('city') ? ', ' . settings('city') : ''); ?><?php echo e(settings('state') ? ', ' . settings('state') : ''); ?></li>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(settings('email')): ?>
