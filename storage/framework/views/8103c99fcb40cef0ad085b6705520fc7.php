            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="p-5 border rounded shadow-sm">
                        ...
                        <form action="<?php echo e(route('certificates.verify')); ?>" method="GET" class="mt-5">
                            <div class="row justify-content-center">
                                <div class="col-md-8">
                                    <div class="form-group mb-0 position-relative">
                                        <input type="text" name="code" class="form-control form-control-lg pl-4 pr-5 rounded-pill border-2" placeholder="Enter Certificate Code (e.g. CERT-XXXXXX)" value="<?php echo e(request('code')); ?>" required style="height: 60px; border-color: #1db6c5;">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->has('code')): ?>
                            <div class="mt-5">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($certificate): ?>
                                    <div class="alert alert-success border-0 ttm-bgcolor-skincolor text-white p-4 rounded d-flex align-items-center animate__animated animate__fadeIn">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0">This certificate is valid and was issued to <strong><?php echo e($certificate->student_name); ?></strong> for the course <strong><?php echo e($certificate->course->title); ?></strong>.</p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body p-4 ttm-bgcolor-grey">
                                            <div class="row">
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <p class="h5"><?php echo e($certificate->student_name); ?></p>
                                                </div>
                                                <div class="col-sm-6 mb-3">
                                                    <p class="text-muted mb-0">Course Title</p>
                                                    <p class="h5"><?php echo e($certificate->course->title); ?></p>
                                                </div>
                                                <div class="col-sm-6 mb-3">
                                                    <p class="text-muted mb-0">Certificate Code</p>
                                                    <p class="h5 text-primary"><?php echo e($certificate->certificate_code); ?></p>
                                                </div>
                                                <div class="col-sm-6 mb-3">
                                                    <p class="text-muted mb-0">Issue Date</p>
                                                    <p class="h5"><?php echo e(\Carbon\Carbon::parse($certificate->issue_date)->format('F d, Y')); ?></p>
                                                </div>
                                            </div>
                                            <div class="text-center mt-4">
                                                <a href="<?php echo e(route('certificates.download', $certificate)); ?>" class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\wamp64\www\education\resources\views/certificates/verify.blade.php ENDPATH**/ ?>