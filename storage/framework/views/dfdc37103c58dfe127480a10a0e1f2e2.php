    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! \Filament\Support\is_slot_empty($slot)): ?>
        <div
            ...
            <?php if($attributes->has('wire:key')): ?>
                wire:ignore.self
                <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('{{ $attributes->get(\'wire:key\') }}.panel', get_defined_vars()); ?>wire:key="<?php echo e($attributes->get('wire:key')); ?>.panel"
            <?php endif; ?>
...
<?php /**PATH E:\wamp64\www\education\vendor\filament\support\resources\views/components/dropdown/index.blade.php ENDPATH**/ ?>