<?php $__env->startSection('title', 'Gallery - CSA Education'); ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div class="gallery-item" style="position: relative; overflow: hidden; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); transition: transform 0.3s ease;">
                        <a href="<?php echo e($gallery->image_url); ?>" data-lightbox="gallery" data-title="<?php echo e($gallery->title); ?>">
                            <img src="<?php echo e($gallery->image_url); ?>" alt="<?php echo e($gallery->title); ?>" style="width: 100%; height: 300px; object-fit: cover; display: block;">
                            <div class="gallery-overlay" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: linear-gradient(to top, rgba(0,0,0,0.8) 0%, transparent 100%); opacity: 0; transition: opacity 0.3s ease; display: flex; align-items: flex-end; padding: 20px;">
                                <div style="color: white;">
                                    <h4 style="margin: 0 0 5px 0; font-size: 18px;"><?php echo e($gallery->title); ?></h4>
                                    ...
                                    <p style="margin: 0; font-size: 14px; opacity: 0.9;"><?php echo e(Str::limit($gallery->description, 60)); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\wamp64\www\education\resources\views/gallery.blade.php ENDPATH**/ ?>